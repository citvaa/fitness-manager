...
export function ClientAppointmentsPage(){
  ...
  return <main className="workspace-page appointments-page">
    ...
    <div className="calendar-list-layout"><MonthCalendar value={selectedDate} onChange={setSelectedDate} highlightedDates={new Set(appointments.map(item=>item.date))} mutedDates={closure.mutedDates} mutedWeekdays={closure.mutedWeekdays} mutedDateReasons={closure.mutedDateReasons} mutedWeekdayReasons={closure.mutedWeekdayReasons}/><div>
