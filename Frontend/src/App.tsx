...
export default function App(){return <Routes><Route path="/login" element={<LoginPage/>}/><Route path="/app" element={<ProtectedShell/>}><Route index element={<RoleHome/>}/><Route path="live" element={<ManagerOnly><Suspense fallback={loading('Učitavanje plana…')}><LivePlanPage/></Suspense></ManagerOnly>}/><Route path="editor" element={<ManagerOnly><Suspense fallback={loading('Učitavanje editora…')}><EditorPage/></Suspense></ManagerOnly>}/><Route path="insights" element={<ManagerOnly><Suspense fallback={loading('Učitavanje uvida…')}><ManagerInsightsPage/></Suspense></ManagerOnly>}/><Route path="progress" element={<ProgressOnly><Suspense fallback={loading('Učitavanje napretka…')}><ProgressPage/></Suspense></ProgressOnly>}/></Route><Route path="*" element={<Navigate to="/app" replace/>}/></Routes>}
