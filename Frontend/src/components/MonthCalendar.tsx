...
export function MonthCalendar({value,onChange,highlightedDates,mutedDates=new Set()}:{value:string;onChange:(date:string)=>void;highlightedDates:Set<string>;mutedDates?:Set<string>}) {
