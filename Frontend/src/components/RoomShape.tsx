  ...
  return <>
    <Group ref={shapeRef} x={room.posX} y={room.posY} width={room.width} height={room.height} rotation={room.rotationDegrees}
      ...
      onTransformEnd={() => {
        ...
        onChange({...room,posX:node.x(),posY:node.y(),rotationDegrees:node.rotation(),width:Math.max(70,room.width*scaleX),height:Math.max(60,room.height*scaleY)},true)
      }}>
